...
7. Type `@` and confirm built-in `explore` plus toolkit `index`, `deep`, and `review` are available.
8. Run `/index` in a content-heavy repo to confirm the free retrieval helper can build/search the project index.
