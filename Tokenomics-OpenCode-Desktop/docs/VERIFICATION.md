> Historical validation before V1. Current release: [V1 verification](V1-VERIFICATION.md).
...
`codex/finish-desktop-cli` in `the pre-V1 checkout`; no merge or remote publication was performed.
