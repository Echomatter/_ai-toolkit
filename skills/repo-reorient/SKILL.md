...
3. Inspect the files, tests, manifests, and entry points relevant to the requested task. Avoid mapping unrelated subsystems; for where/how code questions, hand off to `enhanced-explore` once orientation is sufficient.
